        ...
        <div className="p-8">
            ...
            <div className="space-y-3">
              {orderData.items.map((item) => (
                <div key={item.id} className="flex justify-between items-center bg-gray-50 rounded-lg p-3">
                  ...
                  <span className="font-bold text-purple-600">₹{(item.price * item.qty)}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-6 mb-6">
            <div className="flex justify-between items-center">
              ...
              <span className="text-2xl font-bold text-purple-600">₹{orderData.total}</span>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <button
              onClick={onClose}
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 px-6 rounded-xl font-semibold hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200"
            >
              Continue Shopping
            </button>
          </div>
